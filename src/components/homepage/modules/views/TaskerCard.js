...
export function TaskerCardOne() {
    ...
    return (
        <div>
            <div class="blog-card">
                <div class="meta">
                    <div class="photo" style={{ backgroundImage: "url('https://www.airtasker.com/images/homepage/tasker-samantha.jpg')" }}></div>
                    <ul class="details">
...
export function TaskerCardTwo() {
    ...
    return (
        <div>
            ...
            <div class="meta">
                    <div class="photo" style={{ backgroundImage: "url('https://www.airtasker.com/images/homepage/tasker-emily.jpg')" }}></div>
                    <ul class="details">
...
export function TaskerCardThree() {
    ...
    return (
        <div>
            <div class="blog-card">
                <div class="meta">
                    <div class="photo" style={{ backgroundImage: "url('https://www.airtasker.com/images/homepage/tasker-brandon.jpg')" }}></div>
                    <ul class="details">
