                    ...
                    <div className="task-item">
                        <div className="item-bubble">
                            <button className="bubble-container">
                                ...
                                <div className="bubble-text"><span>Home Cleaning</span></div>
                            </button>
                        </div>
                        <div className="item-bubble">
                            <button className="bubble-container">
                                <div className="bubble-circle"></div>
                                <div className="bubble-text"><span>Full House Removals</span></div>
                            </button>
                        </div>
                        <div className="item-bubble">
                            <button className="bubble-container">
                                <div className="bubble-circle"></div>
                                <div className="bubble-text"><span>Few Items Removals</span></div>
                            </button>
                        </div>
                        <div className="item-bubble">
                            <button className="bubble-container">
                                <div className="bubble-circle"></div>
                                <div className="bubble-text"><span>Business & Admin</span></div>
                            </button>
                        </div>
                        <div className="item-bubble">
                            <button className="bubble-container">
                                <div className="bubble-circle"></div>
                                <div className="bubble-text"><span>Computers & IT</span></div>
                            </button>
                        </div>
                        <div className="item-bubble">
                            <button className="bubble-container">
                                <div className="bubble-circle"></div>
                                <div className="bubble-text"><span>Furniture Assembly</span></div>
                            </button>
                        </div>
                        <div className="item-bubble">
                            <button className="bubble-container">
                                <div className="bubble-circle"></div>
                                <div className="bubble-text"><span>Handyman</span></div>
                            </button>
                        </div>
                        <div className="item-bubble">
                            <button className="bubble-container">
                                <div className="bubble-circle"></div>
                                <div className="bubble-text"><span>Marketing & Design</span></div>
                            </button>
                        </div>
                        <div className="item-bubble">
                            <button className="bubble-container">
                                <div className="bubble-circle"></div>
                                <div className="bubble-text"><span>Event & Photography</span></div>
                            </button>
                        </div>
                        <div className="item-bubble">
                            <button className="bubble-container">
                                <div className="bubble-circle"></div>
                                <div className="bubble-text"><span>Fun & Quirky</span></div>
                            </button>
                        </div>
                        <div className="item-bubble">
                            <button className="bubble-container">
                                <div className="bubble-circle"></div>
                                <div className="bubble-text"><span>Home & Gardening</span></div>
                            </button>
                        </div>
                        <div className="item-bubble">
                            <button className="bubble-container">
                                <div className="bubble-circle"></div>
                                <div className="bubble-text"><span>Anything</span></div>
                            </button>
                        </div>
                    </div>
