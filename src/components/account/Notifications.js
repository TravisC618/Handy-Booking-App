        ...
        <div className="notifications vertical-scroll">
            <div className="notifications-container">
                <div className="notifications__page">
                    <img src={notifications} alt="no_results" className="page__EmptyImg" />
                        <p className="page__text">
                            This is where we'll let you know about tasks, comments and other stuff. 
                            Let's post a task or make an offer!
                        </p>
